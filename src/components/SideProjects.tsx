...
export function SideProjects() {
  ...
  return (
    <section id="side-projects" className="relative py-24 md:py-32">
      ...
      <div className="section-container relative" ref={ref}>
        <div className={`mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-white/40 max-w-xl text-sm mt-2">
            Experimental builds and interactive control-theory demos created to test ideas quickly and compare controller behavior in real time.
          </p>
        </div>
